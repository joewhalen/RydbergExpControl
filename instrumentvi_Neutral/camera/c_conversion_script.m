%%%Last revision 2006/08/16, by Pascal.
%%%Modifying so that conversion to C is possible.
%%%2006/01/30 changes include having Matlab do more of the heavy lifting than LabView and adding a ROI algorithm.
...
prebinning=CCDbinning*sampleinterleave;
